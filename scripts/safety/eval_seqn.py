...
def eval_seqn_main(example_nums_feedlist, data_distilled, eval_subdirname, eval_di, pid=0):
    """
    ...
    seqn_filled_lfps_sketches = hack_seqn_filled_sketches(example_nums_feedlist, data_distilled, pid)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dirname", type=str, default="train/utcustom")
    parser.add_argument("--eval_di", type=str, default="sam1120/safety-utcustom-train-v1.0")
