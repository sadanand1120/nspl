...
if __name__ == "__main__":
    ...
    seqn_lfps_sketches = json_reader(os.path.join(nspl_root_dir, "scripts/llm/ablation_direct/seqn_lfps_sketches.json"))
    for i in range(1, 30):
    ...
    json_writer(os.path.join(nspl_root_dir, "scripts/llm/ablation_direct/seqn_filled_lfps_sketches.json"), seqn_filled_lfps_sketches)
